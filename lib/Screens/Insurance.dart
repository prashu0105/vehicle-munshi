                  ...
                  child: Column(
                    children: [
                      RadioListTile(
                          ...
                          title: Text("Light Motor Vehicle"),
                      ...
                      RadioListTile(
                          activeColor: MunshiColor().munshiBlue,
                          title: Text("Heavy Motor Vehicle"),
                          tileColor: MunshiColor().munshiBlue,
                          value: "Heavy",
                          groupValue: radiovalue,
                          onChanged: (value) {
                ...
                onTap: () {
                  if (radiovalue == "Light") {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LightMotorVehicle()));
                  } else if (radiovalue == "Heavy") {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => HeavyMotorVehicle()));
                  } else {}
                },
                child: Center(
                  child: Container(
