...
class LightMotorVehicle extends StatefulWidget {
  ...
  @override
  State<LightMotorVehicle> createState() => _LightMotorVehicleState();
}

class _LightMotorVehicleState extends State<LightMotorVehicle> {
  var h, w;
  var radiovalue = "New";
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('Light Motor Insurance'),
