...
class ProfessionalPackage extends StatefulWidget {
  ProfessionalPackage({Key? key}) : super(key: key);

  @override
  State<ProfessionalPackage> createState() => _ProfessionalPackageState();
}

class _ProfessionalPackageState extends State<ProfessionalPackage> {
  var h, w;
  var radiovalue;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('Professional Package'),
