...
class NewPermit extends StatefulWidget {
  NewPermit({Key? key}) : super(key: key);

  @override
  State<NewPermit> createState() => _NewPermitState();
}

class _NewPermitState extends State<NewPermit> {
  var h, w;
